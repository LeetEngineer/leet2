(() => {
      ...
      addClient(_0x3fae9b) {
        if (this.clients.length >= this.maxClientsAllowed) {
          ...
          if (this.clients.length === 1) {
            this.setClient(_0x3fae9b); // Set as Parent
            this.log("Added Parent:", _0x3fae9b);
          } else if (this.clients.length === 2) {
            this.primaryChild = _0x3fae9b; // Set as Primary Child (Child 1)
            this.log("Added Primary Child:", _0x3fae9b);
          } else {
            this.log("Added Child " + (this.clients.length - 1) + ":", _0x3fae9b);
          }
        }
      }

      getChildClients() {
        return this.clients.filter(client => client.clientType === "child");
      }
    ...
    const _0x518936 = new class {
      ...
      ["updateScene"](_0xc209c9) {
        _0xa630e8.clients.forEach((_0x100616, _0xf5167c) => {
          _0x100616.updateBound();
          _0x100616.stores.cellsToRemove.forEach(_0x3ae55f => {
            if (!(_0x3ae55f.flags.isPellet && !_0x2395ab.settings.showPellets)) {
              _0x3ae55f.animate(_0xc209c9);
              this.removedCells.push(_0x3ae55f);
            }
          });
          _0x100616.stores.cellsToRender.forEach(_0x51400e => {
            if (!(_0x51400e.flags.isPellet && !_0x2395ab.settings.showPellets)) {
              _0x51400e.animate(_0xc209c9);
              _0x100616.updateStaticBound(_0x51400e);
              if (!this.reverseCheckView(_0x51400e.targetX, _0x51400e.targetY, _0x51400e.size, _0xf5167c)) {
                if (_0x51400e.flags.isPellet) {
                  this.pelletsFrame.push(_0x51400e);
                }
                if (!_0x51400e.flags.isPellet) {
                  this.cellsFrame.push(_0x51400e);
                }
              }
            }
          });
        });
        this.cellsFrame.sort((_0x352838, _0x27d093) => _0x352838.size == _0x27d093.size ? _0x352838.id - _0x27d093.id : _0x352838.size - _0x27d093.size);
        this.clearCanvas();
        if (_0x2395ab.settings.showGrid) {
          this.drawGrid();
        }
        this.ctx.save();
        this.setCamera();
        if (_0x2395ab.settings.showSectors) {
          this.drawSectors();
        }
        this.drawMapBorder();
        this.removedCells.forEach(_0x19d535 => {
          if (this.isInDisplay(_0x19d535.targetX, _0x19d535.targetY, _0x19d535.size)) {
            _0x19d535.draw(this.ctx);
          }
        });
        this.pelletsFrame.forEach(_0x282a1e => {
          _0x282a1e.draw(this.ctx);
        });
        this.cellsFrame.forEach(_0x2626b1 => {
          if (this.isInDisplay(_0x2626b1.targetX, _0x2626b1.targetY, _0x2626b1.size)) {
            _0x2626b1.draw(this.ctx);
          }
        });
        this.removedCells = [];
        this.pelletsFrame = [];
        ...
        if (_0x2395ab.settings.showDebug) {
          _0xa630e8.clients.forEach(_0xc538d3 => {
            this.drawViewport(this.ctx, _0xc538d3.clientType + " viewport", _0xc538d3.bound.left, _0xc538d3.bound.top, _0xc538d3.bound.right, _0xc538d3.bound.bottom, "parent" === _0xc538d3.clientType ? "red" : "blue", 0xf);
          });
        }
        this.ctx.restore();
        this.drawMinimap();
      ...
      ["loop"]() {
        const _0x5a4a82 = Date.now();
        this.updateMouseWorld();
        this.updateCamera();
        this.updateScene(_0x5a4a82);
    ...
    const _0x2395ab = new class {
      ...
      ['initClient'](_0x2390ba, _0x5ba875) {
        ...
        _0x4d98a0.on("playerDied", () => {
          ...
          _0x2395ab.setElementVisibility(document.getElementById("menu-display"), true);
          _0x2395ab.menuVisible = true;
      ...
      ["switchClient"]() {
        const _0x5bd2b3 = _0xa630e8.getActiveClient(); // Current active client
        const _0x5b671b = _0xa630e8.getParent(); // Parent client
        const _0x1f18fc = _0xa630e8.totalPlaying(); // Total playing clients
      
        // If no parent client exists, create one
        if (!_0x5b671b) {
          if (this.connecting) {
            return;
          }
        ...
        // If the active client is a child and no one is playing, switch to the parent
        if (_0x5bd2b3 && _0x5bd2b3.clientType === "child" && _0x1f18fc === 0) {
          _0xa630e8.setClient(_0x5b671b);
          return void _0x5b671b.sendSpawn();
        }
      
        // If the active client is the parent
        if (_0x5bd2b3 && _0x5bd2b3.clientType === "parent") {
          if (_0x5bd2b3.playing) {
            // Get all child clients
            const _0x28d924 = _0xa630e8.getChildClients();
      
            // Find the next available child client
            let _0x2d0f52 = _0x28d924.find(child => !child.playing);
      
            if (_0x2d0f52) {
              // If a child client is found, switch to it
              _0xa630e8.setClient(_0x2d0f52);
            } else {
              // If no child client is available, create a new one
              _0x2d0f52 = this.initClient('child', this.serverUrl);
            ...
            // If the parent is not playing, spawn it
            _0x5b671b.sendSpawn();
          }
        }
      
        // If the active client is a child
        if (_0x5bd2b3 && _0x5bd2b3.clientType === "child") {
          if (_0x5b671b.playing) {
            // Switch back to the parent if it's playing
            _0xa630e8.setClient(_0x5b671b);
          } else {
            // If the parent is not playing, spawn it
            _0x5b671b.sendSpawn();
      ...
      ['initPlayerInputs']() {
        ...
        this.playerInfo.nickname = _0x3a6a1c.value = localStorage.getItem("ogarx:nickname") || '';
        this.playerInfo.tag = _0xdfd103.value = localStorage.getItem("ogarx:tag") || '';
        const _0x12d85a = localStorage.getItem("ogarx:server") || _0xeeb4e0.options[0x0].value;
        ...
        _0x3a6a1c.addEventListener("input", () => {
          ...
          localStorage.setItem('ogarx:nickname', _0x3a6a1c.value);
        });
        _0xdfd103.addEventListener("input", () => {
          ...
          localStorage.setItem("ogarx:tag", _0xdfd103.value);
        });
        _0xeeb4e0.addEventListener("change", () => {
          const _0x485497 = _0xeeb4e0.value;
          localStorage.setItem("ogarx:server", _0x485497);
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      // Function to create and manage child clients
      function setupClient(clientNumber) {
        const connectButton = document.getElementById(`connect-client-${clientNumber}`);
        const spawnButton = document.getElementById(`spawn-client-${clientNumber}`);
        const statusElement = document.getElementById(`status-client-${clientNumber}`);
      
        let childClient = null;
      
        connectButton.addEventListener("click", () => {
          if (childClient) {
            toastr.info(`Client ${clientNumber} is already connected.`);
            return;
          }
      
          // Create and connect the child client
          childClient = new _0x2275aa("child");
          childClient.connect(_0x2395ab.serverUrl);
      
          // Update status and enable spawn button
          childClient.once("clientReady", () => {
            statusElement.textContent = "Connected";
            statusElement.style.color = "green";
            spawnButton.disabled = false;
            toastr.success(`Client ${clientNumber} connected successfully!`);
      
            // Auto-respawn when the client dies
            childClient.on("playerDied", () => {
              //toastr.info(`Client ${clientNumber} died. Respawning...`);
              childClient.sendSpawn();
            });
          });
          ...
          childClient.on("error", () => {
            statusElement.textContent = "Failed";
            statusElement.style.color = "red";
            spawnButton.disabled = true;
            toastr.error(`Client ${clientNumber} connection failed.`);
          });
      
          // Handle disconnection
          childClient.on("close", () => {
            statusElement.textContent = "Not Connected";
            statusElement.style.color = "gray";
            spawnButton.disabled = true;
            toastr.warning(`Client ${clientNumber} disconnected.`);
            childClient = null;
          });
        });
        ...
        spawnButton.addEventListener("click", () => {
          if (!childClient) {
            toastr.error(`Client ${clientNumber} is not connected.`);
            return;
          }
      
          // Spawn the child client
          childClient.sendSpawn();
          toastr.info(`Client ${clientNumber} spawned.`);

          childClient.once("playerAlive", () => {
            const primaryClient = _0xa630e8.getParent(); // Get the primary client (client 1 or 2)
            if (primaryClient) {
              followPrimaryCell(childClient, primaryClient);
            }
          });
        });
      }
      ...
      // Set up clients 2 to 5
      for (let i = 2; i <= 35; i++) {
        setupClient(i);
      }

      function followPrimaryCell(childClient, primaryClient) {
        if (!primaryClient || !childClient) return;
      
        // Continuously update the child client's cursor position to match the primary cell
        const followInterval = setInterval(() => {
          if (primaryClient.stores.ownedCells.length > 0) {
            const primaryCell = primaryClient.stores.ownedCells[0];
            childClient.sendCursorPosition(primaryCell.x, primaryCell.y);
      
            // Automatically split the child client if it's playing
            if (childClient.playing) {
              childClient.sendSplit(1); // Split once
            }
          }
    ...
    class Chat {
      ...
      connect() {
        this.socket = new WebSocket('wss://chat.delt.iio');
